  ...
  return (
    <div className="client-section">
      ...
      <div className="client-cards">
        ...
        <div data-aos="fade-up" className="client-item">
          <img src={image3} alt="clientimage" />
          <div data-aos="fade-in" className="client-info">
            <h1>PHILIPS</h1>
        ...
        <div data-aos="fade-up" className="client-item">
          <div data-aos="fade-in" className="client-info-projects">
      ...
      <div data-aos="fade-up" className="client-quote">
        <p>
